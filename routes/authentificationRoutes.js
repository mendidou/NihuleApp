...
router.post('/register', async function (req, res, next) {
  try {
    ...
    pool.query(SQL, [email, hashedPassword], function (dbError, dbResult) {
      ...
      const SQL = "CREATE TABLE mendouledailyreport (id SERIAL ,date DATE, credit INT, debit INT, apt INT, name TEXT,receipt INT ,for TEXT ,details TEXT,paymenttype TEXT ,provider TEXT,differentsprovider TEXT,detailsdiferentProviders TEXT,remarks TEXT)"
